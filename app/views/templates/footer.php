            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="#">ARIO LIBRARY</a>, All Right Reserved.

                        Designed By <a class="border-bottom" href="http://yogiario.my.id">Yogi Ario</a>
                    </div>
    ...
    <script src="<?= BASEURL; ?>/lib/wow/wow.min.js"></script>
